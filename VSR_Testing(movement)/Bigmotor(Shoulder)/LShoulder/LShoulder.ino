...
#define UPPER_LIMIT_PIN 7  // Upper limit switch on pin 7
#define LOWER_LIMIT_PIN 6  // Lower limit switch on pin 6
#define PWM 10       // PWM pin for motor speed control
#define IN2 33        // Motor driver input 2 in4
#define IN1 35        // Motor driver input 1 in3
