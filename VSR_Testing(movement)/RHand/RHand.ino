...
#define SENSOR_PIN 21   // IR Slot Sensor D0 connected to pin 18
#define UPPER_LIMIT_PIN 4  // Upper limit switch on pin 2
#define LOWER_LIMIT_PIN 5  // Lower limit switch on pin 3
#define PWM 53         // PWM pin for motor speed control
#define IN2 51         // Motor driver input 2
#define IN1 49         // Motor driver input 1
...
void moveToPosition(int targetPos) {
  ...
  const unsigned long TIMEOUT = 7000; // Stop trying after 7 seconds
